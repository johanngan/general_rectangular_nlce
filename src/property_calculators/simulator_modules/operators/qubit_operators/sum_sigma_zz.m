function psi_out = sum_sigma_zz(psi_in, pairs)
    % Applies the weighted sum products of pairs of sigma_z Pauli matrices
    ...
    psi_out = sum_bilocal(psi_in, pairs, @sigma_zz);
end
