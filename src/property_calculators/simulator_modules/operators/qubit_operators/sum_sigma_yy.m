function psi_out = sum_sigma_yy(psi_in, pairs)
    % Applies the weighted sum products of pairs of sigma_y Pauli matrices
    ...
    psi_out = sum_bilocal(psi_in, pairs, @sigma_yy);
end
